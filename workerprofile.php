...
<?php
	...
	//		echo "id is:".$_SESSION["wid"];
			...
			if (isset($_POST["Signupbtn"]))
			{
				...
				Gender='".$gender."',DateofJoin='".$dateofjoin."',ContactNo1='".$contactNumber1."',ContactNo2='".$contactNumber2."',EMailId='".$email."',AddharNumber='".$addharnumber."',City='".$city."',profession='".$profession."',Charges='".$charges."' WHERE  WorkerId =".$_SESSION["wid"];
