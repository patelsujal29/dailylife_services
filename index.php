...
$sql = "SELECT * FROM `worker` WHERE EMailId ='$username'  and WorkerPassword = '$password'";
...
$_SESSION["wid"] = $raw[0];
  header('Location: Workerdashbord.php');
...
<table>
	...
	<div class="user-details">
	  ...
	  <label>Email Address</label>
          <input type="text" name="Emailid" id="ClientId" required>
        </div><br>
        <div class="input-box">
        <label>Password</label>  
				<input type="password" name="password" id="Clientpwd" required>
        </div>
	<div class="input-box">
	<br> <a href="WorkerSignup.php">New user??</a>
