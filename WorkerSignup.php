<?php
	...
	$smt="INSERT INTO `worker`( `WorkerPassword`, `FirstName`, `MiddleName`, `LastName`, `Gender`, `DateofJoin`, `ContactNo1`, `ContactNo2`, `EMailId`,`AddharNumber`, `City`, `profession`, `Charges`)
	VALUES ('$wpassword','$wfname','$wmname','$wlname','$wgender','$wdateofjoin','$wcnumber1','$wcnumber2','$wemail','$adharnumber','$city','$profession','$charges')";
...
<body>
    ...
    <div class="content">
		...
		<div class="user-details">
            ...
            <input type="password" name="Workerpassword" placeholder="Worker password" required>
			</div>
			<div class="input-box">
		...
		<div class="input-box">
            ...
            <input type="text" name="adharnumber" placeholder="Adhar Number" required>
		</div>
