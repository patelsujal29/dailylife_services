...
<?php
		//	session_start();
			...
			if(isset($id))
			{
				$selectQuery = "select * from worker where WorkerId= " . $id;
			...
			if (isset($_POST["Signupbtn"]))
			{
				...
				Gender='".$gender."',DateofJoin='".$dateofjoin."',ContactNo1='".$contactNumber1."',ContactNo2='".$contactNumber2."',EMailId='".$email."',AddharNumber='".$addharnumber."',City='".$city."',profession='".$profession."',Charges='".$charges."' WHERE  WorkerId =".$id;
    ...
    <div class="content">
		...
		<div class="user-details">
			...
			<div class="input-box">
            <span class="details">Addhar Number</span>
            <input type="text" name="addharnumber" placeholder="Addhar Number" value = <?php echo $addharnumber?>>
			</div>
