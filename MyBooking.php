...
<br><br><br><p style="text-align: center ; color: #FF0000; font-size: 20px; " >*Note:- <br>
	->we gives you contact number of worker, plz contact him to set your available time.<br> 
    ->To verify worker we provide workers adhar details to you, please verify carefully.<br>
    ->Our company is not responsible if any mishappening occur due to worker(first make sure validate worker) </p>
</div>
</form>
</body>
</html>
